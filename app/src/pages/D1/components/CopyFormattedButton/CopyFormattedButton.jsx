  ...
  const handleCopyFormattedData = async () => {
    try {
      ...
      data.forEach((pedido, index) => {
        ...
        mensagem += `• Base: ${pedido['Base de entrega'] || pedido['Base de Entrega'] || pedido['BASE'] || pedido['Base'] || baseName}\n`
        ...
        mensagem += `• Complemento: ${pedido['Complemento'] || 'N/A'}\n`
        mensagem += `• Tempo de Pedido parado: ${pedido['Tempo de Pedido parado'] || pedido['Tempo de Pedido Parado'] || 'N/A'}\n`
        mensagem += `• Horário de saída para entrega: ${pedido['Horário de saída para entrega'] || pedido['Horário de Saída para Entrega'] || 'N/A'}\n\n`
      })
